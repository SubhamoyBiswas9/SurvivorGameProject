...
[CreateAssetMenu(fileName = "Wave Data", menuName = "SpawnData/Wave Data")]
public class WaveData : SpawnData
{
    ...
    public override GameObject[] GetSpawns(int totalEnemies = 0)
    {
        ...
        // If we have less than <minimum Enemies> on the screen, we will 
        // set the count to be equals to the number of enemies to spawn to 
        // populate the screen until it has <minimum Enemies> within.
